...
const Download = () => {
  return (
    <section
      id="download"
      className="py-20 md:py-32 bg-forest text-primary-foreground overflow-hidden relative"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-primary-foreground/80 mb-10 max-w-lg">
              Join thousands of families who trust EatSure to keep their food safe. Free to
