...
const features = [
  {
    ...
    description: "Browse and search current food recalls issued by U.S. food safety agencies, with clear explanations of what each recall means.",
    color: "bg-primary",
  },
  {
    icon: Receipt,
    title: "Check products you buy",
    description: "Automatic tracking of your grocery through your shopping receipt. Snap a photo or connect your store account.",
    color: "bg-coral",
  },
  {
    icon: ArrowRight,
    title: "Know what to do next",
    description: "Get clear guidance on recommended actions such as discarding, returning, or monitoring a product.",
    color: "bg-forest",
  },
];
        ...
        <div className="mt-20 grid md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              EatSure monitors recalls 24/7 and sends you personalized alerts based on your shopping history and location. Never miss an important safety update.
            </p>
              ...
              <div className="bg-background rounded-2xl p-5 shadow-card max-w-sm transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Fresh Express salad kits recalled due to possible Listeria contamination. Check your fridge.</p>
              ...
              <div className="bg-background rounded-2xl p-5 shadow-soft max-w-sm absolute -bottom-4 -left-4 -z-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Your recent purchases have been checked. No recalls found.</p>
                  </div>
                </div>
              </div>
            </div>
