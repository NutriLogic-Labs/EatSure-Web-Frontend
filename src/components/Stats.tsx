      ...
      <div className="container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-display-md md:text-display-lg text-foreground mb-6 text-balance">
            Food safety affects <span className="text-primary">millions</span> every year
          </h2>
          <p className="text-lg text-muted-foreground">
            In the United States alone, millions of people get sick each year from contaminated or
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div
            ref={stat1.ref}
            className="bg-background rounded-3xl p-8 md:p-10 text-center shadow-soft hover:shadow-card transition-shadow duration-300"
          >
            <div className="text-display-xl text-primary mb-2">~{stat1.count}M</div>
          ...
          <div
            ...
            className="bg-background rounded-3xl p-8 md:p-10 text-center shadow-soft hover:shadow-card transition-shadow duration-300"
          >
            <div className="text-display-xl text-coral mb-2">~{stat2.count}K</div>
          ...
          <div
            ...
            className="bg-background rounded-3xl p-8 md:p-10 text-center shadow-soft hover:shadow-card transition-shadow duration-300"
          >
            <div className="text-display-xl text-forest mb-2">~{stat3.count}K</div>
